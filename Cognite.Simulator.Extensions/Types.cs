...
namespace Cognite.Simulator.Extensions
{
    ...
    public class SimulationInput : SimulationTimeSeries
    {
        ...
        //     $"{Calculation.Model.Simulator}-INPUT-{Calculation.GetCalcTypeForIds()}-{ReferenceId}-{Calculation.Model.GetModelNameForIds()}"
        //     : ExternalIdOverwrite;
    ...
    public class SimulationOutput : SimulationTimeSeries
    {
        ...
        /// </summary>
        // public override string TimeSeriesExternalId => string.IsNullOrEmpty(ExternalIdOverwrite) ?
        //     $"{Calculation.Model.Simulator}-OUTPUT-{Calculation.GetCalcTypeForIds()}-{ReferenceId}-{Calculation.Model.GetModelNameForIds()}"
        //     : ExternalIdOverwrite;
