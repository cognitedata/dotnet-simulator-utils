...
namespace Cognite.Simulator.Tests.UtilsTests
{
    ...
    public class ModelLibraryExtertnalDepsTest : IDisposable
    {
        ...
        private static Func<HttpResponseMessage> MockSimulatorModelRevEndpoint(string status = "unknown")
        {
        ...
        public async Task TestModelLibraryWithExternalDependencies()
        {
            ...
            var endpointMockTemplates = new List<SimpleRequestMocker>
            {
                ...
                new SimpleRequestMocker(uri => uri.Contains("/simulators/models/revisions/byids"), MockSimulatorModelRevEndpoint("success"), 2),
