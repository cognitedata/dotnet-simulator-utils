...
{
    public class SeedDataFlowsheets
    {
        public static Dictionary<string, string> SimulatorModelRevisionDataDictionary = new Dictionary<string, string>
        {
            { "cronExpression", "*/5 * * * *"},
        };
        public static List<SimulatorModelRevisionDataFlowsheet> SimulatorModelRevisionData = new List<SimulatorModelRevisionDataFlowsheet>
        {
            new SimulatorModelRevisionDataFlowsheet {
        ...
        new SimulatorModelRevisionDataObjectNode
        {
            ...
            SimulatorObjectEdges = new List<SimulatorModelRevisionDataObjectEdge>() {
                new SimulatorModelRevisionDataObjectEdge
                {
                    Id = "Edge-1",
                    Name = "Test Edge",
                    SourceId = "test_edge_3",
                    TargetId = "test_edge_4",
